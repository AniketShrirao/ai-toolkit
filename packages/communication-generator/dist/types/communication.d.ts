import { BaseEntity, ProjectEstimate, Requirement, DocumentAnalysis } from "./shared.js";
export type CommunicationType = "initial-contact" | "proposal" | "status-update" | "project-completion" | "follow-up" | "clarification-request";
