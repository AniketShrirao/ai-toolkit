...
export const createMockOllamaService = () => {
    return {
        generateText: vi
            .fn()
            .mockResolvedValue("SUBJECT: Enhanced Subject\n\nBODY:\nEnhanced body content with AI improvements."),
...
// Test data factories
export const createTestRequirements = () => [
    {
        id: "req-1",
        type: "functional",
        priority: "high",
...
export const createTestEstimate = () => ({
    id: "est-1",
    totalHours: 80,
    totalCost: 8000,
    breakdown: [
...
export const createTestAnalysis = () => ({
    structure: {
        sections: [
            {
                id: "sec-1",
    ...
    requirements: {
        ...
        nonFunctional: createTestRequirements().filter((r) => r.type === "non-functional"),
        totalCount: 3,
    },
    keyPoints: [
        {
    ...
    summary: {
        length: "medium",
        content: "This project involves developing a comprehensive web application with user authentication, analytics dashboard, and performance optimization.",
        keyPoints: [
            "User authentication",
            "Analytics dashboard",
...
export const createTestPersonalization = () => ({
...
export const createTestRequest = (type = "initial-contact", audienceType = "business", format = "email") => ({
    type,
    format,
    audienceType,
