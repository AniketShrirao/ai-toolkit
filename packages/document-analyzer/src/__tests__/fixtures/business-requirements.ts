import { ProcessedDocument, DocumentType } from "@ai-toolkit/shared";

export const businessRequirementsDocument: ProcessedDocument = {
  id: "business-req-001",
...
export const technicalSpecDocument: ProcessedDocument = {
  id: "tech-spec-001",
...
export const projectProposalDocument: ProcessedDocument = {
  id: "proposal-001",
