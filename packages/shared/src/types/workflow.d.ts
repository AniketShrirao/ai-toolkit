import { BaseEntity, WorkflowStatus } from './common.js';
...
export type WorkflowStepType = 'document-analysis' | 'requirement-extraction' | 'estimation' | 'communication-generation' | 'codebase-analysis' | 'file-operation' | 'notification';
