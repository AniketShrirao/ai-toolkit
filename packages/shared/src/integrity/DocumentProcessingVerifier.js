...
export class DocumentProcessingVerifier {
    ...
    async verifyDocumentProcessing() {
        const issues = [];
        try {
    ...
    generateReport(documents, issues) {
    ...
    calculateDataQualityScore(issues, totalDocuments) {
        if (totalDocuments === 0)
            return 100;
        if (issues.length === 0)
            return 100;
    ...
    generateRecommendations(issues, documents) {
...
//# sourceMappingURL=DocumentProcessingVerifier.js.map