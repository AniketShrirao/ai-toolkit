 ...
 */
import { ErrorCategory } from "./ErrorTypes.js";
export class TroubleshootingGuideManager {
    ...
    getGuideForError(error) {
        return (this.guides.get(error.code) || this.guides.get(error.category) || null);
    }
    /**
    ...
    initializeBuiltInGuides() {
        ...
        this.registerGuide("OLLAMA_CONNECTION_FAILED", {
            ...
            description: "The AI Toolkit cannot connect to the Ollama service. This is required for AI-powered document analysis and processing.",
            ...
            steps: [
                {
                    ...
                    expected: "Version information should be displayed (e.g., ollama version is 0.1.0)",
                },
                {
                    step: 2,
                    description: "Install Ollama if not present",
                    action: "Visit https://ollama.ai and follow installation instructions for your operating system",
                ...
                },
                {
                    ...
                    expected: "Ollama should start and display 'Ollama is running on http://localhost:11434'",
                },
                {
                    step: 4,
                    description: "Verify the service is accessible",
                    action: "Open http://localhost:11434 in your browser or run: curl http://localhost:11434",
        ...
        this.registerGuide("OLLAMA_MODEL_ERROR", {
            ...
            description: "The requested AI model is not available or failed to respond. This may be due to the model not being downloaded or insufficient system resources.",
            ...
            steps: [
                ...
                },
                {
                    ...
                    expected: "Model should download successfully (may take 10+ minutes for large models)",
                },
                {
                    step: 3,
                ...
                },
                {
                    ...
                    action: "Monitor RAM usage - models require 4-8GB+ of available memory",
        ...
        this.registerGuide("DOCUMENT_PROCESSING_FAILED", {
            ...
            description: "The system failed to process your document. This could be due to file format issues, corruption, or processing limitations.",
            ...
            steps: [
                {
                    ...
                    action: "Verify the file is in a supported format (PDF, DOCX, TXT, MD)",
                    expected: "File should have a supported extension and be readable",
                },
                {
                    step: 2,
                    description: "Test file integrity",
                    action: "Try opening the file in its native application (e.g., Adobe Reader for PDF)",
        ...
        this.registerGuide("WORKFLOW_EXECUTION_FAILED", {
            ...
            description: "An automated workflow failed to complete. This may be due to configuration issues, dependency failures, or resource constraints.",
            ...
            steps: [
                {
                    ...
                    action: "Review the workflow definition for syntax errors or missing parameters",
                    expected: "Configuration should be valid JSON/YAML with all required fields",
                },
                {
                    step: 2,
                ...
                },
                {
                    ...
                    action: "Verify that input files and parameters are valid and accessible",
                ...
                },
                {
                    ...
                    action: "Try running workflow steps individually to isolate the problem",
        ...
        this.registerGuide("FILE_SYSTEM_ERROR", {
            ...
            description: "A file operation failed. This is typically due to permission issues, disk space, or file locks.",
            ...
            steps: [
                ...
                },
                {
                    ...
                    action: "Ensure sufficient free disk space (at least 1GB recommended)",
        ...
        this.registerGuide("CONFIGURATION_ERROR", {
            ...
            description: "The application configuration is invalid or missing required settings.",
            ...
            steps: [
                {
                    ...
                    action: "Verify the configuration file is present in the expected location",
...
//# sourceMappingURL=TroubleshootingGuide.js.map