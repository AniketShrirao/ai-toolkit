...
export interface QueueManager {
    addJob<T = any>(queueName: string, jobName: string, data: T, options?: JobOptions): Promise<string>;
    getJob(jobId: string): Promise<Job | null>;
    removeJob(jobId: string): Promise<boolean>;
    createQueue(name: string, options?: QueueOptions): Promise<boolean>;
    ...
    processJobs<T = any>(queueName: string, processor: JobProcessor<T>, concurrency?: number): Promise<void>;
    ...
    cleanCompletedJobs(queueName: string, olderThan?: Date): Promise<number>;
    scheduleJob<T = any>(queueName: string, jobName: string, data: T, scheduleTime: Date, options?: JobOptions): Promise<string>;
    scheduleRecurringJob<T = any>(queueName: string, jobName: string, data: T, cronExpression: string, options?: JobOptions): Promise<string>;
